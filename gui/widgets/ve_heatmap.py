...
class VEHeatmapWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        if not HAS_PYQTGRAPH:
            ...
            fallback.setStyleSheet(f"color: {COLORS['muted_foreground']}; padding: 48px;")
        ...
        self.hover_info.setStyleSheet(f"color: {COLORS['muted_foreground']}; font-size: 9pt;")
        ...
        self.stats_label.setStyleSheet(f"color: {COLORS['muted_foreground']}; font-size: 9pt;")
    ...
    def _on_hover(self, event) -> None:
        ...
        if self._ve_data.rpm and self._ve_data.load:
            ...
            elif self._view_mode == "diff" and self._ve_data.before and self._ve_data.after:
