...
class DynoConfigPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.loading_label.setStyleSheet(f"color: {COLORS['muted_foreground']}; padding: 24px;")
        ...
        formula_text.setStyleSheet(f"color: {COLORS['muted_foreground']}; font-family: monospace;")
    ...
    def _create_section(self, title: str) -> QVBoxLayout:
        ...
        label = QLabel(title)
        label.setStyleSheet(f"font-size: 10pt; font-weight: bold; color: {COLORS['text_secondary']};")
    ...
    def _add_spec_row(self, grid: QGridLayout, row: int, label: str, value: str, attr_name: str) -> None:
