...
AFR_PRESETS: Dict[AFRPreset, PresetConfig] = {
    AFRPreset.NA_STREET: PresetConfig(
        ...
        icon="💧",
        targets={20: 14.7, 30: 14.7, 40: 14.5, 50: 14.0, 60: 13.5, 70: 13.0, 80: 12.8, 90: 12.5, 100: 12.2},
    ),
    AFRPreset.NA_PERFORMANCE: PresetConfig(
        name="NA Performance",
        description="Aggressive for NA high-performance builds",
        icon="⚡",
        targets={20: 14.7, 30: 14.5, 40: 14.2, 50: 13.8, 60: 13.2, 70: 12.8, 80: 12.5, 90: 12.3, 100: 12.0},
    ),
    AFRPreset.TURBO: PresetConfig(
        name="Turbo/SC",
        description="Richer targets for forced induction",
        icon="🔥",
        targets={20: 14.5, 30: 14.2, 40: 13.8, 50: 13.2, 60: 12.8, 70: 12.3, 80: 11.8, 90: 11.5, 100: 11.2},
    ),
    AFRPreset.E85: PresetConfig(
        name="E85",
        description="Optimized for E85 fuel (~9.8 stoich)",
        icon="⛽",
        targets={20: 14.0, 30: 13.5, 40: 12.8, 50: 12.0, 60: 11.5, 70: 11.0, 80: 10.8, 90: 10.5, 100: 10.2},
    ),
}
