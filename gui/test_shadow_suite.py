...
from gui.components.alert import AlertVariant, create_alert
...
from gui.styles.theme import ShadowTokens, apply_theme
    ...
    def __init__(self):
        ...
        for name, color, desc in tokens:
            ...
            color_box.setStyleSheet(
                f"background-color: {color}; border: 1px solid {ShadowTokens.BORDER};"
            )
