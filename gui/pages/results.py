...
class MetricCard(QFrame):
    ...
    def __init__(
        self, label: str, value: str, icon: str = "", parent: Optional[QWidget] = None
    ):
...
class ResultsPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.download_csv_btn = Button(
            "Download CSV", ButtonVariant.SECONDARY, icon="📥"
        )
        ...
        self.download_report_btn = Button(
            "Download Report", ButtonVariant.DEFAULT, icon="📄"
        )
        ...
        self.heatmap_placeholder_label.setStyleSheet(
            f"color: {COLORS['muted_foreground']};"
        )
        heatmap_placeholder_layout.addWidget(
            self.heatmap_placeholder_label, alignment=Qt.AlignmentFlag.AlignCenter
        )
