...
from gui.api.client import APIClient, AnalysisRun
...
class HistoryPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.loading_label.setStyleSheet(f"color: {COLORS['muted_foreground']}; padding: 48px;")
        ...
        empty_desc = QLabel("Run your first analysis from the Dashboard to see results here.")
    ...
    def _on_runs_received(self, runs: List[AnalysisRun]) -> None:
        ...
        self.empty_state.setVisible(False)
        self.count_label.setText(f"{len(runs)} analysis run{'s' if len(runs) != 1 else ''}")
