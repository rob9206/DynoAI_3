...
class TestPreflightIntegration:
    ...
    def test_preflight_with_no_providers(self):
        ...
        with patch("api.services.jetdrive.jetdrive_client.discover_providers", new_callable=AsyncMock) as mock_discover:
    ...
    def test_preflight_passes_with_good_data(self):
        ...
        import asyncio
        from api.services.jetdrive.jetdrive_preflight import run_preflight
        from api.services.jetdrive.jetdrive_client import JetDriveProviderInfo, ChannelInfo
        ...
        with patch("api.services.jetdrive.jetdrive_client.discover_providers", new_callable=AsyncMock) as mock_discover:
            ...
            with patch("api.services.jetdrive.jetdrive_client.subscribe", side_effect=mock_subscribe):
                result = asyncio.run(run_preflight(sample_seconds=1))
