...
class TestVEDataEndpointBasic:
    ...
    @staticmethod
    def test_ve_data_returns_404_for_missing_run(client):
        """VE data returns 404 for non-existent run ID."""
        response = client.get("/api/ve-data/nonexistent-run-id")
        assert response.status_code == 404

    @staticmethod
    def test_ve_data_returns_json(client, mock_output_folder):
    ...
    @staticmethod
    def test_ve_data_contains_required_fields(client, mock_output_folder):
    ...
    @staticmethod
    def test_ve_data_rpm_is_list(client, mock_output_folder):
    ...
    @staticmethod
    def test_ve_data_load_is_list(client, mock_output_folder):
    ...
    @staticmethod
    def test_ve_data_corrections_is_2d_array(client, mock_output_folder):
    ...
    @staticmethod
    def test_ve_data_before_after_same_dimensions(client, mock_output_folder):
...
class TestVEDataEndpointInputValidation:
    ...
    @staticmethod
    def test_ve_data_rejects_dots_only_run_id(client):
        """VE data returns 404 for run_id containing only dots."""
        response = client.get("/api/ve-data/...")
        assert response.status_code == 404

    @staticmethod
    def test_ve_data_rejects_empty_sanitized_run_id(client):
