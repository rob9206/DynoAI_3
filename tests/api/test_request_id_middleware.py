...
class TestRequestIDMiddleware:
    ...
    @staticmethod
    def test_auto_generated_request_id_in_header(client):
    ...
    @staticmethod
    def test_request_id_is_hex_format(client):
    ...
    @staticmethod
    def test_client_provided_id_with_special_chars(client):
    ...
    @staticmethod
    def test_client_id_in_error_response(client):
    ...
    @staticmethod
    def test_request_id_on_post_requests(client):
    ...
    @staticmethod
    def test_request_id_on_validation_error(client):
    ...
    @staticmethod
    def test_empty_client_id_generates_new(client):
...
class TestRequestIDHelper:
    ...
    @staticmethod
    def test_get_request_id_import():
    ...
    @staticmethod
    def test_get_request_id_raises_outside_context():
