...
class TestEfficiencyScoring:
    ...
    def test_wot_pull_multiplier():
        ...
        gain_steady, eff_steady = score_test_efficiency(
            step_steady, current_coverage=50.0
        )
    ...
    def test_priority_boost():
        ...
        gain_high, eff_high = score_test_efficiency(
            step_high_pri, current_coverage=50.0
        )
