...
class TestEfficiencyScoring:
    ...
    def test_wot_pull_multiplier(self):
        ...
        gain_wot, eff_wot = score_test_efficiency(step_wot, current_coverage=50.0)
        gain_steady, eff_steady = score_test_efficiency(step_steady, current_coverage=50.0)
    ...
    def test_priority_boost(self):
        ...
        gain_high, eff_high = score_test_efficiency(step_high_pri, current_coverage=50.0)
        gain_low, eff_low = score_test_efficiency(step_low_pri, current_coverage=50.0)
    ...
    def test_small_region_low_gain(self):
        ...
        gain_large, _ = score_test_efficiency(step_large, current_coverage=50.0)
        gain_small, _ = score_test_efficiency(step_small, current_coverage=50.0)
