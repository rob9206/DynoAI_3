...
def compare_kernels(k1_results: Dict[str, Any], k2_results: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for dataset in datasets:
        ...
        comparison['metrics_comparison'][dataset] = {
            've_energy': {
                ...
                'k2_vs_k1_ratio': k2_data['ve_energy'] / k1_data['ve_energy'] if k1_data['ve_energy'] != 0 else float('inf')
            },
            'stability': {
                'k1': k1_data['stability'],
                'k2': k2_data['stability'],
                'k2_vs_k1_ratio': k2_data['stability'] / k1_data['stability'] if k1_data['stability'] != 0 else float('inf')
            },
            'runtime_ms': {
                'k1': k1_data['runtime_ms'],
                'k2': k2_data['runtime_ms'],
                'k2_vs_k1_ratio': k2_data['runtime_ms'] / k1_data['runtime_ms'] if k1_data['runtime_ms'] != 0 else float('inf')
            }
        }
...
def main():
    ...
    if k1_results:
        ...
        for dataset in comparison['datasets']:
            ...
            print(f"VE Energy - K1: {comp['ve_energy']['k1']:.3f}, K2: {comp['ve_energy']['k2']:.3f}, K2/K1: {comp['ve_energy']['k2_vs_k1_ratio']:.3f}")
            print(f"Stability - K1: {comp['stability']['k1']:.6f}, K2: {comp['stability']['k2']:.6f}, K2/K1: {comp['stability']['k2_vs_k1_ratio']:.3f}")
            print(f"Runtime - K1: {comp['runtime_ms']['k1']:.1f}ms, K2: {comp['runtime_ms']['k2']:.1f}ms, K2/K1: {comp['runtime_ms']['k2_vs_k1_ratio']:.3f}")
    # Save results
