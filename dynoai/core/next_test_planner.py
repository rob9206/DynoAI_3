    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "coverage_gaps_detailed": (
                ...
                if self.coverage_gaps_detailed
                else []
            ),
...
class CoverageGap:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "coverage_pct": (
                round((self.total_cells - self.empty_cells) / self.total_cells * 100, 1)
...
def generate_test_plan(
    ...
    if cumulative_coverage is None:
        ...
        current_coverage = (
            (covered_cells / total_cells * 100) if total_cells > 0 else 0.0
        )
    else:
    ...
    priority_rationale = (
        ...
        if rationale_parts
        else "Standard coverage improvement plan"
    )
