...
class EnvironmentalConditions:
    ...
    def __post_init__(self):
        ...
        if self.altitude_ft is None:
            self.altitude_ft = estimate_altitude_from_baro(
...
class EnvironmentalCorrector:
    ...
    def _calculate_pressure_correction(
        ...
        pressure_ratio = (
            conditions.barometric_pressure_inhg / self.reference.pressure_inhg
        )
    ...
    def _is_standard_day(self, conditions: EnvironmentalConditions) -> bool:
        ...
        """
        pressure_ok = (
            abs(conditions.barometric_pressure_inhg - self.reference.pressure_inhg)
            < 0.5
        )
