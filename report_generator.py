...
def generate_pdf_report(
    ...
    score_hex = colors.HexColor(f"#{int(score_color[0]*255):02x}{int(score_color[1]*255):02x}{int(score_color[2]*255):02x}")
    ...
    story.append(Paragraph(
        f"<b>Verification Hash:</b> {verification_hash[:32]}...",
        body_style
    ))
    story.append(Spacer(1, 0.2*inch))
