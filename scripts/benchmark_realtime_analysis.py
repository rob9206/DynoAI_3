...
def benchmark_on_aggregated_sample(engine: RealtimeAnalysisEngine, num_samples: int = 1000):
...
def main():
    ...
    results.append(("on_aggregated_sample", benchmark_on_aggregated_sample(engine, 1000)))
