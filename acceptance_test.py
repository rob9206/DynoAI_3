...
from ve_operations import VEApply, VERollback, write_ve_table, read_ve_table, compute_sha256
...
def test_requirement_3_metadata():
    ...
    applier = VEApply()
    metadata = applier.apply(base_path, factor_path, output_path, metadata_path=metadata_path)
...
def test_requirement_5_dry_run():
    ...
    # Apply with dry-run
    applier = VEApply()
    metadata = applier.apply(base_path, factor_path, output_path, 
